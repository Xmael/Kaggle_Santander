...
stack_rf(nfolds=nfolds-1,train=learners_train_1st,test=learners_test_1st,folds=pfolds,ntree=50)
stack_svm(nfolds=nfolds-1,train=learners_train_1st,test=learners_test_1st,folds=pfolds,kernel)
stack_xgboost(nfolds=nfolds-1,train=learners_train_1st,test=learners_test_1st,folds=pfolds,eta)
